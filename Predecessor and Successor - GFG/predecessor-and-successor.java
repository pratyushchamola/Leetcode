...
class GfG
{
    public static void inorderpre(Node root,int key, Res p){
        // if(root == null)return;
    ...
    public static void preordersucc(Node root,int key,Res s){
    ...
    public static void findPreSuc(Node root, Res p, Res s, int key)
    {
       ...
       inorderpre(root,key,p);
       preordersucc(root,key,s);
    }
}